...
import { LucideLayoutDashboard, LucideBuilding2, LucideImage, LucideMessageSquare, LucideLogOut, LucideMenu, LucideX } from '@lucide/angular';

@Component({
  selector: 'ahram-admin-sidebar',
  standalone: true,
  imports: [RouterLink, RouterLinkActive, LucideLayoutDashboard, LucideBuilding2, LucideImage, LucideMessageSquare, LucideLogOut, LucideMenu, LucideX],
