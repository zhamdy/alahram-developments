...
export class ProjectFormComponent implements OnInit {
        ...
        next: res => {
          if (res.success) {
            ...
            this.form.set({
              ...
              fullDescriptionAr: p.fullDescriptionAr ?? (p as unknown as { full_description_ar: string }).full_description_ar ?? '',
              fullDescriptionEn: p.fullDescriptionEn ?? (p as unknown as { full_description_en: string }).full_description_en ?? '',
  ...
  protected onSubmit(): void {
    ...
    const data = {
      ...
      fullDescriptionAr: f.fullDescriptionAr,
      fullDescriptionEn: f.fullDescriptionEn,
